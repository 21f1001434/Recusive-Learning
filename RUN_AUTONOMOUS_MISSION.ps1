...
Write-Host "Starting autonomous HIP mission: Data Map through BizFlow." -ForegroundColor Cyan
Write-Host "The agent will compile a parent-child dependency path, commit parents before children, complete repeatable rows sequentially, exploit validated paths first, explore only on drift, and auto-resume proven phases." -ForegroundColor Cyan
